...
<div class="project-form box">
    <div class="project-form__header">
        <h1 class="project-form__title title">J'édite mon projet</h1>
    </div>
    <hr>
        ...
        <form action="{{route('projects.update', [$project, $slug])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="materials-fields-box">
                <div class="materials-fields-box__fields-box field">
                    ...
                    $inputsNumber = count($project->materials);
                    @endphp
            ...
            <div class="time-fields-box">
                <div class="field">
                    ...
                    <div class="time-fields-box__d-flex">
                        <div class="control">
                            <input class="input @error('duration') is-danger @enderror is-rounded" type="text" placeholder="2" name="duration" value="{{$project->duration}}">
                        </div>
            ...
            <div class="budget-fields-box">
                <div class="field">
                    ...
                    <div class="budget-fields-box__d-flex">
                        <div class="control">
                            <input class="input @error('budget') is-danger @enderror is-rounded" name="budget" type="text" placeholder="2" value="{{$project->budget}}">
                        </div>
