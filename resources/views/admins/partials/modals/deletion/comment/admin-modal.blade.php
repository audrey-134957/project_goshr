...
<div class="modal">
    ...
    <div class="modal-card">
        ...
        <header class="modal-card-head">
            <h1 class="modal-card-title">Suppression du commentaire n° {{$comment->id}}</h1>
        </header>
        ...
        <div class="modal-body">
            ...
            <form action="{{route('admin.deleteComment', ['adminId' => auth()->user()->id, 'project' => $project, 'slug' => $project->slug, 'comment' => $comment])}}" method="POST">
                    @method('DELETE')
                    @csrf
