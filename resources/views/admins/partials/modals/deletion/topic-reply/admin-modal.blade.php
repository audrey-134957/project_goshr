...
<div class="modal">
    ...
    <div class="modal-card">
        ...
        <header class="modal-card-head">
            <h1 class="modal-card-title">Suppression du topic n° {{$topicReply->id}}</h1>
        </header>
        ...
        <div class="modal-body">
            ...
            <form action="{{route('admin.deleteTopic', ['adminId' => auth()->user()->id, 'project' => $project, 'slug' => $project->slug, 'topic' => $topicReply])}}" method="POST">
                    @method('DELETE')
                    @csrf
