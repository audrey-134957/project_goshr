...
/***/ "./resources/js/apis/file-reader.js":
/*!******************************************!*\
  !*** ./resources/js/apis/file-reader.js ***!
  \******************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var fileReader = {
  run: function run() {
    //je stocke la boxe de téléchargement de fichier en variable
    var fileImage = $('.box__input--file'); //s'il y a du changement dans cette box

    fileImage.on('change', function () {
      //je stocke le label de l'image en variable
      var filePreview = $('.box__label--image'); //je fais appel à une nouvel instance de FileReader

      var reader = new FileReader(); //à son chargement
      ...
      var file = this.files[0]; //je lis le fichier téléchargé
...
/***/ "./resources/js/apis/summernote-lite.js":
/*!**********************************************!*\
  !*** ./resources/js/apis/summernote-lite.js ***!
  \**********************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {__webpack_require__(/*! summernote/dist/summernote-lite */ "./node_modules/summernote/dist/summernote-lite.js");

var summernote = {
  run: function run() {
    $('.summernote').summernote({
      toolbar: [['font', ['bold', 'underline']], ['para', ['ul', 'ol', 'paragraph']], ['insert', ['picture']]],
      ...
      callbacks: {
        onImageUpload: function onImageUpload(files) {
          ...
          var file = files[0]; // create FileReader
  ...
  stickyToolbar: function stickyToolbar() {
    if (window.location.href.indexOf("je-poste-un-projet") > -1 || window.location.href.indexOf("modifier-mon-projet") > -1 || window.location.href.indexOf("modifier-mon-brouillon") > -1) {
      $('.note-toolbar').css({
        'position': 'sticky',
        'top': '58px',
        'z-index': '3'
  ...
  customImageModal: function customImageModal() {
    if (window.location.href.indexOf("je-poste-un-projet") > -1 || window.location.href.indexOf("modifier-mon-projet") > -1 || window.location.href.indexOf("modifier-mon-brouillon") > -1) {
  ...
  resizeImagesInsideSummernote: function resizeImagesInsideSummernote() {
    var projectIllustration = $(".project-article__main img");
    projectIllustration.attr({
      width: "100%"
    });
...
__webpack_require__(/*! ../js/components/menu */ "./resources/js/components/menu.js");

__webpack_require__(/*! ../js/elements/temporary-notification */ "./resources/js/elements/temporary-notification.js");

__webpack_require__(/*! ../js/apis/file-reader */ "./resources/js/apis/file-reader.js");

__webpack_require__(/*! ../js/apis/summernote-lite */ "./resources/js/apis/summernote-lite.js");

__webpack_require__(/*! ../js/components/menu */ "./resources/js/components/menu.js");

__webpack_require__(/*! ../js/components/thumbnail */ "./resources/js/components/thumbnail.js");

__webpack_require__(/*! ../js/components/modal */ "./resources/js/components/modal.js");

__webpack_require__(/*! ../js/components/qa-textzone */ "./resources/js/components/qa-textzone.js");

__webpack_require__(/*! ../js/components/comment-textzone */ "./resources/js/components/comment-textzone.js");

__webpack_require__(/*! ../js/components/admin-navbar */ "./resources/js/components/admin-navbar.js");

__webpack_require__(/*! ../js/components/call-to-action-textzone */ "./resources/js/components/call-to-action-textzone.js");

__webpack_require__(/*! ../js/elements/fields/material-field */ "./resources/js/elements/fields/material-field.js");

__webpack_require__(/*! ../js/elements/scroll-to-content */ "./resources/js/elements/scroll-to-content.js");

__webpack_require__(/*! ../js/elements/category-form */ "./resources/js/elements/category-form.js");

/***/ }),

/***/ "./resources/js/components/admin-navbar.js":
/*!*************************************************!*\
  !*** ./resources/js/components/admin-navbar.js ***!
  \*************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var adminNavbar = {
  toggle: function toggle() {
    ...
    adminVerticalNavbarBtn.on('click', function () {
      adminVerticalNavbar.animate({
        width: 'toggle'
      }, 500).removeClass('is-hidden');
    });
  }
};
adminNavbar.toggle();
...
/***/ "./resources/js/components/call-to-action-textzone.js":
/*!************************************************************!*\
  !*** ./resources/js/components/call-to-action-textzone.js ***!
  \************************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var callToAction = {
...
/***/ "./resources/js/components/comment-textzone.js":
/*!*****************************************************!*\
  !*** ./resources/js/components/comment-textzone.js ***!
  \*****************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var commentTextzone = {
  toggleEditTextzone: function toggleEditTextzone() {
  ...
  toggleReplyTextzone: function toggleReplyTextzone() {
...
/* WEBPACK VAR INJECTION */(function($) {var menu = {
  toggleVerticalMenu: function toggleVerticalMenu() {
...
/* WEBPACK VAR INJECTION */(function($) {var modal = {
  open: function open() {
  ...
  checkIfMotiveIsSelected: function checkIfMotiveIsSelected() {
...
/***/ "./resources/js/components/qa-textzone.js":
/*!************************************************!*\
  !*** ./resources/js/components/qa-textzone.js ***!
  \************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var qaTextzone = {
  toggleEditTextzone: function toggleEditTextzone() {
...
/***/ "./resources/js/elements/category-form.js":
/*!************************************************!*\
  !*** ./resources/js/elements/category-form.js ***!
  \************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var categoryForm = {
  toggle: function toggle() {
    ...
    editBtn.on('click', function () {
      // alert('ok');
      $(this).parent().parent().next(edit).toggleClass('is-hidden');
    });
  }
};
categoryForm.toggle();
...
/***/ "./resources/js/elements/fields/material-field.js":
/*!********************************************************!*\
  !*** ./resources/js/elements/fields/material-field.js ***!
  \********************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var projectMaterialField = {
  addFieldDynamically: function addFieldDynamically() {
    ...
    materialBtn.on('click', function () {
      ...
      if (materialInput < maxMaterialsInputs) {
        ...
        if (window.location.href.indexOf("/projets/je-poste-un-projet") > -1) {
          var input = '<div class="materials-fields-box__material-box control">' + '<span class="materials-fields-box__dot">&#x25CF;</span>' + '<input class="is-rounded input" name="material[]" type="text" placeholder="" id="' + materialInput + '">' + '</div>';
        } else {
          var input = '<div class="materials-fields-box__material-box control">' + '<span class="materials-fields-box__dot">&#x25CF;</span>' + '<input class="is-rounded input" name="new_material[]" type="text" placeholder="" id="' + materialInput + '">' + '</div>';
        }
...
/***/ "./resources/js/elements/scroll-to-content.js":
/*!****************************************************!*\
  !*** ./resources/js/elements/scroll-to-content.js ***!
  \****************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var scrollToContent = {
  scrollSmooth: function scrollSmooth() {
    ...
    */
    ...
    if (url.indexOf(endpoint) > -1 && $('#' + endpoint).is('.topic-card') || $('#' + endpoint).is('.comment-card')) {
      ...
      $('#' + endpoint).addClass('box--focus'); //je vais sroller jusqu'à la carte ciblée.

      $("html, body").stop().animate({
        scrollTop: $('#' + endpoint).offset().top - 150
      }, 2000);
    }
  }
};
...
/***/ "./resources/js/elements/temporary-notification.js":
/*!*********************************************************!*\
  !*** ./resources/js/elements/temporary-notification.js ***!
  \*********************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var temporaryNotification = {
  slideUp: function slideUp() {
    //je stocke la notification en variable
    var notif = $('.notification'); //s'il existe une notification
...
__webpack_require__(/*! /var/www/html/Goshr/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/html/Goshr/resources/sass/app.scss */"./resources/sass/app.scss");
